...
def arithmetic(prob_matrix=None,N=10,message=None,image_path=None):    # ?unction to perform arithmetic coding
    cumul_matrix={}
    if (prob_matrix == None or message == None):   # If probability tablw or 1-D array to encode are not given
    ...
    for i in range(len(prob_matrix)):
        cumul_matrix[prob_matrix[i][0]]=[Decimal(sum),Decimal(sum+prob_matrix[i][1])]
